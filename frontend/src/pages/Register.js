    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-6">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-black font-heading tracking-tighter mb-2" data-testid="register-title">
            Create Account
          </h1>
          <p className="text-base text-muted-foreground">Join DevQA and start testing</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6" data-testid="register-form">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.role} onValueChange={(value) => setFormData({ ...formData, role: value })}>
                <SelectTrigger className="bg-background border-white/10" data-testid="register-role-select">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
